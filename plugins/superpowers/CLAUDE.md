...
- **工具脚本在仓库根 `bin/`**（vision.py / review.py / office_tools.py / latex_build.py / security-audit-tools.py / style_reference_docx.py）

## 相关

- 科研骨架全景与工具：上级仓库（claude-useful-skills）README
